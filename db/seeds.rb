...
itineraries = [
  ...
  { post_id: 5, title: "市場食べ歩き", body: "キンパ、トッポギ、クァベギ", start_time: DateTime.parse("2025-05-17 12:00:00+09:00"), finish_time: DateTime.parse("2025-05-17 15:00:00+09:00"), address: Faker::Address.full_address, latitude: Faker::Address.latitude.to_f, longitude: Faker::Address.longitude.to_f, what_day: 2, traffic_method: 4, traffic_time_hour: 00, traffic_time_min: 30 },
  { post_id: 5, title: "明洞ぶらり", body: "ジェントルモンスターの店舗行きたい", start_time: DateTime.parse("2025-05-17 16:00:00+09:00"), finish_time: DateTime.parse("2025-05-17 20:00:00+09:00"), address: Faker::Address.full_address, latitude: Faker::Address.latitude.to_f, longitude: Faker::Address.longitude.to_f, what_day: 2, traffic_method: 5, traffic_time_hour: 00, traffic_time_min: 30 },
  ...
  { post_id: 6, title: "ラーメン", body: "とんこつラーメン", start_time: DateTime.parse("2025-10-02 18:00:00+09:00"), finish_time: DateTime.parse("2025-10-02 22:00:00+09:00"), address: Faker::Address.full_address, latitude: Faker::Address.latitude.to_f, longitude: Faker::Address.longitude.to_f, what_day: 2, traffic_method: 0, traffic_time_hour: 00, traffic_time_min: 30 },
]
